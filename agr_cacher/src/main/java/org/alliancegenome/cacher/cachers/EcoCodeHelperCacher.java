...
public class EcoCodeHelperCacher extends Cacher {
    ...
    protected void cache() {
        ...
        allEcos.forEach((key, ecoTerms) -> basicManager.setCache(key, ecoTerms, classView, CacheAlliance.ECO_MAP));
        ...
        closure.forEach((parent, children) -> basicManager.setCache(parent, new ArrayList(children), classView, CacheAlliance.CLOSURE_MAP));
