...
public interface ExpressionRESTInterface {
	...
	JsonResultResponse<ExpressionDetail> getExpressionAnnotations(@Parameter(in = ParameterIn.QUERY, name = "geneID", description = "Gene by ID", required = true) @RequestBody List<String> geneIDs,
		...
		@Parameter(in = ParameterIn.QUERY, name = "filter.stage", description = "Stage name", schema = @Schema(type = SchemaType.STRING)) @QueryParam("filter.stage") String filterStage,
		@Parameter(in = ParameterIn.QUERY, name = "filter.assay", description = "Assay name", schema = @Schema(type = SchemaType.STRING)) @QueryParam("filter.assay") String filterAssay,
		...
		@Parameter(in = ParameterIn.QUERY, name = "filter.term", description = "Ontology term name", schema = @Schema(type = SchemaType.STRING)) @QueryParam("filter.term") String filterTerm,
		@Parameter(in = ParameterIn.QUERY, name = "filter.source", description = "Source", schema = @Schema(type = SchemaType.STRING)) @QueryParam("filter.source") String filterSource,
		...
		@DefaultValue("geneName") @QueryParam("sortBy") String sortBy, @Parameter(in = ParameterIn.QUERY, name = "asc", description = "order to sort by", schema = @Schema(type = SchemaType.STRING)) // ,allowableValues = "true,false")
