...
//,allowedValues = "true,false")
	...
	@APIResponses(value = { @APIResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Null.class))) })
	JsonResultResponse<GeneDiseaseAnnotationDocument> getDiseaseAnnotationsRibbonDetailsWithoutPrimaryAnnotations(
	...
	@POST
	@Path("")
	@Operation(summary = "Retrieve all disease annotations of a given set of genes", hidden = true)
	@APIResponses(value = { @APIResponse(responseCode = "200", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Null.class))) })
