...
public interface GeneRESTInterface {
    ...
    JsonResultResponse<Allele> getAllelesPerGene(
            ...
            @QueryParam("filter.alleleCategory") String category
    );
    ...
    JsonResultResponse<AlleleVariantSequence> getAllelesVariantPerGene(
            ...
            @Parameter(in = ParameterIn.QUERY, name = "filter.consequenceType", description = "Consequence Type", schema = @Schema(type = SchemaType.STRING))
            @QueryParam("filter.consequenceType") String consequenceType,
