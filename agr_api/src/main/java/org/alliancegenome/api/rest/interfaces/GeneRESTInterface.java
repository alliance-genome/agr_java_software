...
public interface GeneRESTInterface {
    ...
    @Operation(summary = "Retrieve a Gene for given ID")
    Gene getGene(
    ...
    @Operation(summary = "Retrieve all disease annotations for a given gene and containsFilterValue option", hidden = true)
