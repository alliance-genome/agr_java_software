...
public class Constants {
    ...
    public static final String VARIANT_DOCUMENT_CREATOR_DISPLAY_INTERVAL = "VARIANT_DOCUMENT_CREATOR_DISPLAY_INTERVAL";
    
    public static final String VARIANT_DOCUMENT_CREATOR_CONTEXT_QUEUE_SIZE = "VARIANT_DOCUMENT_CREATOR_CONTEXT_QUEUE_SIZE";
    public static final String VARIANT_DOCUMENT_CREATOR_CONTEXT_TRANSFORMER_THREADS = "VARIANT_DOCUMENT_CREATOR_CONTEXT_TRANSFORMER_THREADS";
    public static final String VARIANT_DOCUMENT_CREATOR_JSON_QUEUE_SIZE = "VARIANT_DOCUMENT_CREATOR_JSON_QUEUE_SIZE";

    // Variant Indexer 
    public static final String VARIANT_JSON_INDEXER_THREADS = "VARIANT_JSON_INDEXER_THREADS";
    public static final String VARIANT_JSON_INDEXER_ES_BULK_ACTION_SIZE = "VARIANT_JSON_INDEXER_ES_BULK_ACTION_SIZE";
    public static final String VARIANT_JSON_INDEXER_ES_BULK_CONCURRENT_REQUESTS = "VARIANT_JSON_INDEXER_ES_BULK_CONCURRENT_REQUESTS";
    public static final String VARIANT_JSON_INDEXER_JSON_QUEUE_SIZE = "VARIANT_JSON_INDEXER_JSON_QUEUE_SIZE";
    public static final String VARIANT_JSON_INDEXER_BULK_THREADS = "VARIANT_JSON_INDEXER_BULK_THREADS";
    public static final String VARIANT_JSON_INDEXER_ES_BULK_SIZE_MB = "VARIANT_JSON_INDEXER_ES_BULK_SIZE_MB";
    public static final String VARIANT_JSON_INDEXER_ES_INDEX_NUMBER_OF_SHARDS = "VARIANT_JSON_INDEXER_ES_INDEX_NUMBER_OF_SHARDS";
