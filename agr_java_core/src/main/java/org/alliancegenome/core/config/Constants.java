...
public class Constants {
    ...
    public static final String VARIANT_DOCUMENT_CREATOR_CONTEXT_INDEXER_THREADS = "VARIANT_DOCUMENT_CREATOR_CONTEXT_INDEXER_THREADS";
    ...
    public static final String VARIANT_ES_BULK_CONCURRENT_REQUESTS = "VARIANT_ES_BULK_CONCURRENT_REQUESTS";
