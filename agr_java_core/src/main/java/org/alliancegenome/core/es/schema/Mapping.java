...
public class Mapping extends Builder {
	...
	protected void buildSharedSearchableDocumentMappings() throws IOException {
		...
		new FieldBuilder(builder, "abstractText", "text").standardText().build(); // literature
		new FieldBuilder(builder, "authors", "text").keyword().autocomplete().keywordAutocomplete().build(); // literature
		...
		new FieldBuilder(builder, "publicationYear", "keyword").build(); // literature
