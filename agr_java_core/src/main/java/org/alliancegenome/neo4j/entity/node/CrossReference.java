...
public class CrossReference extends Neo4jEntity {
	...
	@JsonView({ PublicView.API.class, PublicView.Interaction.class, PublicView.Expression.class, CurationView.VariantSummaryDocument.class }) private String crossRefCompleteUrl;
	...
	@JsonView({ PublicView.API.class, PublicView.Interaction.class, CurationView.VariantSummaryDocument.class }) private String name;

	@JsonView({ PublicView.API.class, PublicView.Interaction.class, CurationView.VariantSummaryDocument.class }) private String displayName;
