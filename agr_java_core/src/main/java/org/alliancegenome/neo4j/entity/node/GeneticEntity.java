...
public class GeneticEntity extends Neo4jEntity {
	...
	@JsonView({PublicView.API.class, PublicView.PhenotypeAPI.class, PublicView.DiseaseAnnotation.class, PublicView.Homology.class, PublicView.GeneAlleleVariantSequenceAPI.class, CurationView.VariantSummaryDocument.class})
	...
	@JsonView(value = {PublicView.API.class, PublicView.GeneAllelesAPI.class, PublicView.GeneAlleleVariantSequenceAPI.class, CurationView.VariantSummaryDocument.class})
	...
	@JsonView(value = {PublicView.API.class, CurationView.VariantSummaryDocument.class})
	...
	@JsonView({PublicView.API.class, CurationView.VariantSummaryDocument.class})
	...
	@JsonView({ PublicView.GeneAllelesAPI.class, PublicView.AlleleAPI.class, PublicView.Default.class, CurationView.VariantSummaryDocument.class })
