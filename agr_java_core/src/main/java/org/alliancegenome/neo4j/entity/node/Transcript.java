...
public class Transcript extends Neo4jEntity implements Comparable<Transcript> {
	...
	@JsonView({ View.Default.class, View.API.class, View.AlleleVariantSequenceConverterForES.class }) protected String name;
	...
	@JsonView({ View.Default.class, View.API.class }) private String intronExonLocation;
