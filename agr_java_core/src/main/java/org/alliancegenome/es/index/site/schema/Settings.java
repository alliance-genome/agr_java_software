				...
				.startObject("analysis")
					.startObject("char_filter")
						.startObject("zero_pad_numbers")
							...
							.field("pattern", "(\\d+)")
							.field("replacement", "00000000000000000000$1")
						.endObject()
						.startObject("trim_padded_numbers")
							.field("type", "pattern_replace")
							.field("pattern", "0*(\\d{20})")
							.field("replacement", "$1")
						.endObject()
					.endObject()
					...
					.startObject("normalizer")
						...
						.startObject("smart_alpha_sort")
							.field("type", "custom")
							.field("filter", "lowercase")
							.array("char_filter", new String[]{"zero_pad_numbers", "trim_padded_numbers"})
						.endObject()
					.endObject()
				.endObject();
	}
