...
public class IndexerCache {
    ...
    public void addCachedAlleleFields(Iterable<AlleleVariantSequence> documents) {
        for (AlleleVariantSequence document : documents) {
            addCachedAlleleFields(document);
        }
    }
    public void addCachedAlleleFields(AlleleVariantSequence document) {
        String id = document.getPrimaryKey();
