...
*/
    ...
    static Map<FieldFilter, List<String>> diseaseFieldFilterMap = new HashMap<>(10);
    ...
    static {
        ...
        diseaseFieldFilterMap.put(FieldFilter.GENETIC_ENTITY_TYPE, Arrays.asList("featureDocument.symbol"));
