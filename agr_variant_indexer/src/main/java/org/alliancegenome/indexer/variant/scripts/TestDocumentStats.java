...
public class TestDocumentStats {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader reader = new BufferedReader(new InputStreamReader(new GZIPInputStream(new FileInputStream(new File("/Volumes/balrog/Variants/HUMAN.v2.vep.chr7.vcf.2.json.gz")))));
